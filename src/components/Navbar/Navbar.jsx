...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div
        id="large-screen"
        className={`flex h-20 w-[96vw] items-center justify-between rounded-2xl bg-white text-black shadow-lg transition-all duration-500 dark:bg-[#0c0c0c]  dark:text-white`}
      >
        {/* Logo */}
        <div id="logo" className="pl-6 font-medium">
          ...
          <span className={`dark:text-neon-green px-1 text-2xl text-blue-600`}>
            {"/"}
          </span>
          <span
            className={`font-firacode dark:text-neon-green pr-1 text-3xl text-blue-600`}
